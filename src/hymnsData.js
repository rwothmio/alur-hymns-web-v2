const hymns = [
  ...
  },
  {
    ...
    body: [
      [
        "Yesu Imio kwo ira, dwong' ubed iri nja.\nKeth apoi piri ku ba saa, nyuth ira Kalvari.",
        "Keth apoi pi Gethsemane, keth apoi de pi can peri.\nMan keth apoi pi mer peri, nyuth ira Kalvari.",
      ],
      [
        "Liel ma ni cana nyutho de, ka ma juyikoi.\nJukur mi polo tundo be, gigwoko avuji.",
        "Keth apoi pi Gethsemane, keth apoi de pi can peri.\nMan keth apoi pi mer peri, nyuth ira Kalvari.",
      ],
      [
        "Ayenyo Rwoth abin beng'i ku giramia de.\nKwij tho uthum, Ivoyo liel kuca wi Kalvari.",
        "Keth apoi pi Gethsemane, keth apoi de pi can peri.\nMan keth apoi pi mer peri, nyuth ira Kalvari.",
      ],
      [
        "Keth atim gin m'Iyenyo ri, i nindona ceke.\nKeth alub toki ku ba ceng', nyuth ira Kalvari.",
        "Keth apoi pi Gethsemane, keth apoi de pi can peri.\nMan keth apoi pi mer peri, nyuth ira Kalvari.",
      ],
    ],
  },
  ...
  },
  {
    ...
    collections: ["HSS 563"],
    titles: [
      "Andha Jalar Rwoth Yesu tho \n(Isaya 53:5-11; Rum 12:1)",
      "O Lord, Remember Me",
    ],
    body: [
      [
  ...
  },
  {
    ...
    body: [
      [
        "Yesu abed ceng'ni In, ceng'ni rimbi keca,\nM'ucwir con ni dhanu yu, kulo mir alwoka.",
        "Ceng'ni In, ceng'ni In, abed ndhu the tiendi.\nCil i ceng' m'atugo woth m'aci ko i beng'i.",
      ],
      [
        "Piny i ng'om a jawirok, kisa peri nwang'a.\nIn m'i cero jobi Iwok In Irienyi wang'a.",
        "Ceng'ni In, ceng'ni In, abed ndhu the tiendi.\nCil i ceng' m'atugo woth m'aci ko i beng'i.",
      ],
      [
        "Ceng'ni In i rombona. In m'Itho kakara.\nKony awoth ma ber andha, cil i ceng' tho para.",
        "Ceng'ni In, ceng'ni In, abed ndhu the tiendi.\nCil i ceng' m'atugo woth m'aci ko i beng'i.",
      ],
      [
        "Yesu, abed ceng'ni In kara In Ikonya.\nAwoth ber ku ba rupiny, ram atund ko kuca.",
        "Ceng'ni In, ceng'ni In, abed ndhu the tiendi.\nCil i ceng' m'atugo woth m'aci ko i beng'i.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "Jarimbwa mbe ro ku Jalar Yesu tak de mbe, tak de mbe\nNg' atu mange mbem'ulwoko cwinywa, tak de mbe, tak de mbe",
        "Yesu ng' eyo pi can mwa ceke, Ebikonyowa i rundi kpo.\nJarimbwa mbe ro ku En ma leng' kwe, tak de mbe, tak de mbe",
      ],
      [
        "Jarimbwa mbe ro ku En ma leng' kwe, tak de mbe, tak de mbe\nJarimbwa mbe ro ku En ma ming' de, tak de mbe, tak de mbe",
        "Yesu ng' eyo pi can mwa ceke, Ebikonyowa i rundi kpo.\nJarimbwa mbe ro ku En ma leng' kwe, tak de mbe, tak de mbe",
      ],
      [
        "Jakristu moko de mbe m'Ekuno, tak de mbe, tak de mbe\nNg'atu m'uyie de mbe m 'Eriemo, tak de mbe, tak de mbe",
        "Yesu ng' eyo pi can mwa ceke, Ebikonyowa i rundi kpo.\nJarimbwa mbe ro ku En ma leng' kwe, tak de mbe, tak de mbe",
      ],
      [
        "Gin moko mbe ro ku Jalar Yesu, tak de mbe, tak de mbe\nMer moko mbe ro ku mer pa Mungu, tak de mbe, tak de mbe",
        "Yesu ng' eyo pi can mwa ceke, Ebikonyowa i rundi kpo.\nJarimbwa mbe ro ku En ma leng' kwe, tak de mbe, tak de mbe",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "Ayeny awoth i yo ma cu ku ba rupiny wakudi Rwoth.\nAcidh i wang'a ndhu ku rwo, Ikura kara kud avoc.",
        "Rwoth peya malu ceng'ni In acung i ng'eti ka\nmaleng'.\nKa ma mugisa sagu kpo, ayenyo aidh malu do.",
      ],
      [
        "Ayenyo ngo adong' kakae, abidhe dit, masendi kwa.\nJumoko foyo ng'om mae, andre ayeny aidh malu.",
        "Rwoth peya malu ceng'ni In acung i ng'eti ka\nmaleng'.\nKa ma mugisa sagu kpo, ayenyo aidh malu do.",
      ],
      [
        "Ayeny' acir abidhe kpo, atim tic ber avoi dubo.\nGin ma tek Mungu nyolo nyen, eloyo ng'om k'awanyane.",
        "Rwoth peya malu ceng'ni In acung i ng'eti ka\nmaleng'.\nKa ma mugisa sagu kpo, ayenyo aidh malu do.",
      ],
      [
  ...
  },
  {
    ...
    body: [
      [
        "Mungu ng'olo i lem pare ya Elingo tek warwo.\nEbiwinjo ywak mwa ceke kud adieng'acwiny mwa kpo.",
        "Mungu winjo rwo mwa do, Ebidwoko wang'e kpo.\nYie kum Eromo ceke, Ebitimo, yie ndhu.",
      ],
      [
        "Ku wakwai ku cwiny ma jiji maku ya wagene ndhu.\nTipo gire kwayu piwa kara rwo mwa winjre cu.",
        "Mungu winjo rwo mwa do, Ebidwoko wang'e kpo.\nYie kum Eromo ceke, Ebitimo, yie ndhu.",
      ],
      [
        "Mungu winjo penji ceke dok enok kadok elwar.\nTek wakwayu ndhu ku nyinge kwayukwac m'areri kwa.",
        "Mungu winjo rwo mwa do, Ebidwoko wang'e kpo.\nYie kum Eromo ceke, Ebitimo, yie ndhu.",
      ],
      [
        "Gin m'urany ku gin m'unyothre tere ndhu iyer ni Rwoth.\nEbijuki ber i canne kum Eng'eyo lembe kpo.",
        "Mungu winjo rwo mwa do, Ebidwoko wang'e kpo.\nYie kum Eromo ceke, Ebitimo, yie ndhu.",
      ],
    ],
  },
  {
    ...
    body: [
      [
        "Wabinendra ndhu i tiend Jalar,\nKa warum nirwo i bang'e.\nThe komker mi bero pare, wabinendra ndhu i tiend Jalar.",
        "Mungu kur kindwa, Ekur kindwa,\nCil i ceng' m'warombo tiend Jalar.\nMungu kur kindwa, Ekur kindwa,\nWabinendra ndhu i tiend Jalar.",
      ],
      [
        "Wabinendra ndhu i tiend Jalar,\nBed museme ku the bombe,\nEbikuri calu rombe, Wabinendra ndhu i tiend Jalar",
        "Mungu kur kindwa, Ekur kindwa,\nCil i ceng' m'warombo tiend Jalar.\nMungu kur kindwa, Ekur kindwa,\nWabinendra ndhu i tiend Jalar.",
      ],
      [
        "Wabinendra ndhu i tiend Jalar,\nEbiyeyi ndhu ku bote,\nIbibedo yo i kore, Wabinendra ndhu i tiend Jalar",
        "Mungu kur kindwa, Ekur kindwa,\nCil i ceng' m'warombo tiend Jalar.\nMungu kur kindwa, Ekur kindwa,\nWabinendra ndhu i tiend Jalar.",
      ],
      [
        "Wabinendra ndhu i tiend Jalar,\nNindo peri kpo ni cinge\nCil m'Ecoki ko i bang'e, Wabinendra ndhu i tiend Jalar",
        "Mungu kur kindwa, Ekur kindwa,\nCil i ceng' m'warombo tiend Jalar.\nMungu kur kindwa, Ekur kindwa,\nWabinendra ndhu i tiend Jalar.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "Rwoth, pir urwo ku lem pare akwei ngo,\nCera, kara kud adubi - pi tin kende.",
        "Pi tin kende, pi tin kende, Rwodha, gwoka.\nTel wia, pi tin kende.",
      ],
      [
        "Keth atim tic kud amora, ku rwo bende\nMi ira berocwiny bende - pi tin kende.",
        "Pi tin kende, pi tin kende, Rwodha, gwoka.\nTel wia, pi tin kende.",
      ],
      [
        "Kud atim yeny m'ayenyo ra, keth abed wor.\nKonya nimira gira dho - pi tin kende.",
        "Pi tin kende, pi tin kende, Rwodha, gwoka.\nTel wia, pi tin kende.",
      ],
      [
        "Kud ayer lembe moko swa m'uromo ngo,\nCer dendhoga ku wec ma rac - pi tin kende.",
        "Pi tin kende, pi tin kende, Rwodha, gwoka.\nTel wia, pi tin kende.",
      ],
    ],
  },
  {
    ...
    body: [
      [
        ...
        "Jalar, Yesu, kud ikuna do!\nKan Ikonyo jumange, Rwoth, kud ikuna do!",
      ],
      [
        "Ia pido kum lem dubo dong' atuce kpo.\nCan unego cwinya ceke, Yesu lara do!",
        "Jalar, Yesu, kud ikuna do!\nKan Ikonyo jumange, Rwoth, kud ikuna do!",
      ],
      [
        "Tipo peri copo konya ku ng'ic para do.\nEtel wia yor i beng'i, Eyik rwona cu.",
        "Jalar, Yesu, kud ikuna do!\nKan Ikonyo jumange, Rwoth, kud ikuna do!",
      ],
      [
        "Yesu In Ijuko cwinya sagu jumange.\nDong' ageno In i kendi, ng'atu mange mbe.",
        "Jalar, Yesu, kud ikuna do!\nKan Ikonyo jumange, Rwoth, kud ikuna do!",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "Yep cwinywa Rwoth Jalar, wakuro dwendi ling'.\nNg'ol iwa gin m'lyenyo ri, wayenyo wawoth leng'.",
        "Yep cwinywa, Rwoth Jalar, keth tic utimbre ber.\nWek Tipo peri romwa kpo, miwa mugisa do.",
      ],
      [
        "Yep cwinywa Rwoth Jalar, yung nyingi edok dwong'.\nRom cwinywa kpo ku lem mi mer, wang' iwa li ve mac.",
        "Yep cwinywa, Rwoth Jalar, keth tic utimbre ber.\nWek Tipo peri romwa kpo, miwa mugisa do.",
      ],
      [
        "Yep cwinywa Rwoth Jalar, nyuth lembe peri ngbeng'.\nKeth thelembe ma ng'eyo tek, ung'eire iwa ber.",
        "Yep cwinywa, Rwoth Jalar, keth tic utimbre ber.\nWek Tipo peri romwa kpo, miwa mugisa do.",
      ],
      [
        "Yep cwinywa Rwoth Jalar, ku Tiponi ma leng'.\nIcer k'i tho wayere cu, wa jumulembene.",
        "Yep cwinywa, Rwoth Jalar, keth tic utimbre ber.\nWek Tipo peri romwa kpo, miwa mugisa do.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        ...
        "Elwoki ku rimo? En Elwoki ku rimbe m'ucwir?\nCwinyi bedo leng' ma sagu vulo kpo?\nEn Elwoki ku rimbe m'ucwir?",
      ],
      [
  ...
  },
  {
    ...
    body: [
      [
        "An amaru Mungu! En ukungu mer mandha,\nYesu bino yenyowa man Etho nilaruwa, wa judubo ceke.",
        "An a nyathin pa Mungu, asikari pa Yesu.\nAbiworo cik pare, tegone bikonya.",
      ],
      [
  ...
  },
  {
    ...
    body: [
      [
        "Dwand Rwodha mit ira m'ulwong'a bin bang'e\nBilwoko ia ku rimbe, m'ucwir wi Kalvari.",
        "(Abebino Rwoth x2) Ko Ilwok ia\nEdok leng', ku rimoni m'ucwir.",
      ],
      [
        "Kadok abedo ng'ic, mi ira tegoni.\nLony gondrina ku rimoni, e poyone bithum.",
        "(Abebino Rwoth x2) Ko Ilwok ia\nEdok leng', ku rimoni m'ucwir.",
      ],
      [
        "Abino Yesu Rwoth, Iketh ageni ndhu.\nIkwio cwinya cungo ti, dwok yioyicna cu.",
        "(Abebino Rwoth x2) Ko Ilwok ia\nEdok leng', ku rimoni m'ucwir.",
      ],
      [
        "Afoyo rimb Yesu, afoyo berone.\nAfoyo Rwoth Yesu Kristu, ku tegone ceke.",
        "(Abebino Rwoth x2) Ko Ilwok ia\nEdok leng', ku rimoni m'ucwir.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "(Bin dhanu yu x2) Wurwinyo dit andha.\nJalar mu de belwong'owu winj dwand Jalar mu tin.",
        "(Bin ba Yesu x2) Ebelwong'owu.\n(Bin ba Yesu x2) Ebilaruwu.",
      ],
      [
        "Kum rimb Jalar yang' con uoi nibodho dhanu yu,\nTuc dubo mu m'ucidowu, rimbe bilwokowu",
        "(Bin ba Yesu x2) Ebelwong'owu.\n(Bin ba Yesu x2) Ebilaruwu.",
      ],
      [
        "Ewacu \"An a lemandha, ku kwo, ku wang'ayo.\"\nKwany yoje ndhu m'igalu ngo, e ibinwang'u kwo.",
        "(Bin ba Yesu x2) Ebelwong'owu.\n(Bin ba Yesu x2) Ebilaruwu.",
      ],
      [
        "Bin mond i kind Jukristo do m'ulubo bedopwe.\nWakudu karacelo wabitundo ka maleng'.",
        "(Bin ba Yesu x2) Ebelwong'owu.\n(Bin ba Yesu x2) Ebilaruwu.",
      ],
    ],
  },
  {
    ...
    body: [
      ...
      [
        "Ceng' ma watundo malu ka maleng', Yesu binen iwa,\nMan Ebidoko Rwoth ni dhanu pet, kerne bibedo nja.",
        "Nen Rombo pa Mungu, rimbe ucwir piwa,\nEcopo bodhowa En e kende, nen Rombo pa Mungu.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        ...
        "(Ajoli i cwinya Jalar x2) kum Inyayu anyong'a\nAfoyo mandha, ajoli i cwinya Jalar.",
      ],
      [
  ...
  },
  {
    ...
    body: [
      [
        "Rwoth Yesu yenyo jumandha, Jukristu ma giwore.\nMa cwinygi kpo ubedo tar, m'uripo ku pa Yesu.",
        "Ameri Yesu In ma Rwoth, ora e abicidho yot.\nAbituco lem mi both, Yesu ma Jakisa.",
      ],
      [
        "Rwoth Yesu yenyo jumandha niponjo Lembe pare.\nNi ju m'urwinyo, ma Jalar usendre pigi bende.",
        "Ameri Yesu In ma Rwoth, ora e abicidho yot.\nAbituco lem mi both, Yesu ma Jakisa.",
      ],
      [
        "Rwoth Yesu yenyo jumandha ma copo voyo dubo.\nWa der mi ng'om, wapondo ngo, wawotho ngo i mudho.",
        "Ameri Yesu In ma Rwoth, ora e abicidho yot.\nAbituco lem mi both, Yesu ma Jakisa.",
      ],
      [
        "Rwoth Yesu yenyo jumandha nikwayu rombe pare.\nWating' nyithindo migi de, wadwokgi de i dwonde.",
        "Ameri Yesu In ma Rwoth, ora e abicidho yot.\nAbituco lem mi both, Yesu ma Jakisa.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "(Lem pa Yesu abiyio x3) Abiyio lembe pa Yesu.",
        "(YomEtelo abilube x3) Abilubo ng'ei Yesu Kristu.",
      ],
      [
        "(Ka can nuti abikwaye x3) Abikwayu ru Yesu Kristu.",
        "(YomEtelo abilube x3) Abilubo ng'ei Yesu Kristu.",
      ],
      [
        "(Lem m'Eyero abiwinjo x3) Abiwinjo lembe pa Yesu.",
        "(YomEtelo abilube x3) Abilubo ng'ei Yesu Kristu.",
      ],
      [
        "(Tic m'Emio abitimo x3) Abitimo ni Yesu Kristu.",
        "(YomEtelo abilube x3) Abilubo ng'ei Yesu Kristu.",
      ],
      [
        "(Ka tho senda abigene x3) Abegeno ru Yesu Kristu.",
        "(YomEtelo abilube x3) Abilubo ng'ei Yesu Kristu.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "Abicidho ma cinga nanu, aci rombo ku Yesu Rwoth?\nRundi meni mi ponjo dhanu, gin mange mak' acor cen.",
  ...
  },
  {
    ...
    body: [
      [
        "An amaru Yesu Kristu, Yesu En e Jalarna\nYesu culo dubo para kuca wi got Kalvari.",
        "An amaru Yesu Kristu, an ayio Yesune\nLembapoka Yesu culo, an ayio rimone",
      ],
      [
        "An amaru Yesu Kristu, Yesu En e Jalarna,\nAn a leng' de ni kum rimbe, rimone mi Kalvari.",
        "An amaru Yesu Kristu, an ayio Yesune\nLembapoka Yesu culo, an ayio rimone",
      ],
      [
        "An amaru Yesu Kristu, Yesu En e Jarimba,\nTin Ebedo mal' i polo karacelo ku Wego.",
        "An amaru Yesu Kristu, an ayio Yesune\nLembapoka Yesu culo, an ayio rimone",
      ],
      [
        "An amaru Yesu Kristu, En e Won aloci kpo.\nCeng' mi lwiny Yesu ni bang'wa Ebiwekowa de ngo.",
        "An amaru Yesu Kristu, an ayio Yesune\nLembapoka Yesu culo, an ayio rimone",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        ...
        "Bin ba derne Emeny iri yo. Edoko derna m'awotho ko.\nCon an abinga dong' wang'a kei\nKum der mi ng'om yu e Yesu.",
      ],
      [
  ...
  },
  {
    ...
    titles: [
      "Ang'o m'uketho Mungu nyutho ira \n(2 Tim 1:12)",
      "I Know Whom I Have",
    ],
    body: [
      [
        "Ang'o m'uketho Mungu nyutho ira berone m'usagre kpo?\nKadok adubo sagu jumange e rimbe lwoko dubona.",
        "Ento an ang'eyo andhandha, ayio mandha ya En\nEcopo nigwoko gin ceke ira cil i ceng' m'Edwogo ko.",
      ],
      [
        "Ang'o m'uketho Mungu mio ira yic m'ayie keth aboth?\nMan tek ayio Lembe pare cu, Ekwio cwinya lwe.",
        "Ento an ang'eyo andhandha, ayio mandha ya En\nEcopo nigwoko gin ceke ira cil i ceng' m'Edwogo ko.",
      ],
      [
        "Ang'o m'uketho Tipo Mungu tuco i cwinya pi dubona?\nEnyutho ira Yesu i Lem pare kar' abed ku yioyic.",
        "Ento an ang'eyo andhandha, ayio mandha ya En\nEcopo nigwoko gin ceke ira cil i ceng' m'Edwogo ko.",
      ],
      [
        "Nyo lembang'o m'ubino i wang'a,\nLembe ma ber kadi ma rac?\nMa fod' aneno wang' Jalarna ngo masendi kadi anyonga?",
        "Ento an ang'eyo andhandha, ayio mandha ya En\nEcopo nigwoko gin ceke ira cil i ceng' m'Edwogo ko.",
      ],
      [
        "Ang eyo ngo nindo ma Rwoth bidwogo, i diewor kadi dieceng.\nNyo abikadhu tipopiny mi tho, nyo wabirombo i lietho.",
        "Ento an ang'eyo andhandha, ayio mandha ya En\nEcopo nigwoko gin ceke ira cil i ceng' m'Edwogo ko.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "Cung ma tek wi lemandha, yung weg bedopwe.\nBed wor de ni Rwoth Yesu, waporu ba Daniel.",
        "Bed tek calu Daniel, bed tek yor i cwiny!\nCung tek wi lembe mandha, iyer ni jumange.",
      ],
      [
        "Ju ma tek girwinyo de kum gilworo dit.\nMungu yenyo tegocwiny walubu tok Daniel.",
        "Bed tek calu Daniel, bed tek yor i cwiny!\nCung tek wi lembe mandha, iyer ni jumange.",
      ],
      [
        "Jurukara dupa de ma gihairi swa,\nGibicungo tak de ngo i wang' ju pa Mungu.",
        "Bed tek calu Daniel, bed tek yor i cwiny!\nCung tek wi lembe mandha, iyer ni jumange.",
      ],
      [
        "Wayer lembanyong'a kwa Mungu telo yo!\nWakied lwiny ma tek ku Jok, walub ko tok Daniel.",
        "Bed tek calu Daniel, bed tek yor i cwiny!\nCung tek wi lembe mandha, iyer ni jumange.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "An amira dho ni Yesu, lembe ceke amio.\nAbimare, abigene, abibedo kude nja.",
        "An amira dho, an amira dho\nAn amira ni Jalarna,\nAn amira dho.",
      ],
      [
        "An amira dho ni Yesu, an ajwigra the tiende.\nLembe mi ng'om kpo aweko, jola Yesu, jola do.",
        "An amira dho, an amira dho\nAn amira ni Jalarna,\nAn amira dho.",
      ],
      [
        "An amira dho ni Yesu, dwoka peri, Jalarna.\nTipo peri rom i ia, Enyuth ira, a peri.",
        "An amira dho, an amira dho\nAn amira ni Jalarna,\nAn amira dho.",
      ],
      [
        "An amira dho ni Yesu, Rwoth, amira dho iri.\nMer ku tegoni rom ia, konj mugisa wia do.",
        "An amira dho, an amira dho\nAn amira ni Jalarna,\nAn amira dho.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "Tic atimo ku mutoro ni Jalar, an atimo ku mutoro.\nEn Eketho kindwa poto, dwoka tek kan atimoni Jalar.",
        "Kan atimo ni Jalar abitino ticne cu\nAbinwang'u lem me ber kwa kan atimo ni Jalar.",
      ],
      [
        "Tic atimo ku mutoro ni Jalar, an atimo ku mutoro.\nKum Ecikukonya ku ba piny m'uru kan atimo ni Jalar.",
        "Kan atimo ni Jalar abitino ticne cu\nAbinwang'u lem me ber kwa kan atimo ni Jalar.",
      ],
      [
        "Tic atimo ku mutoro ni Jalar, an atimo ku mutoro.\nLem m'usenda lund udwoko cwinya tek kan atimo ni Jalar.",
        "Kan atimo ni Jalar abitino ticne cu\nAbinwang'u lem me ber kwa kan atimo ni Jalar.",
      ],
    ],
  },
  {
    ...
    body: [
      [
        "Lembe besendi, e cwinyi dieng? Mungu bigwoki En,\nCor ceng'ni bang'e i vute dri, Mungu bigwoki En.",
        "Mungu bigwoki En, ku ba rupiny, ku diewor de.\nEkengo wi jupare, Mungu bigwoki cil nja.",
      ],
      [
  ...
  },
  {
    ...
    body: [
      [
        "Rwoth gwok cwinya ku ba rupiny (the rimoni x2)\nKab lworo ku dubona de In, the rimoni ma ber.",
        "The rimoni, rimo ma ber, rimo mi lwok ma lwoko jo,\nGwoka Yesu Jalarna ndhu the rimoni ma ber.",
      ],
      [
        "Kapondo pa jadubo e (the rimoni x2)\nInyutho yo mi kwo bende, the rimoni ma ber.",
        "The rimoni, rimo ma ber, rimo mi lwok ma lwoko jo,\nGwoka Yesu Jalarna ndhu the rimoni ma ber.",
      ],
      [
        "Yesu dong' Iroma ndhu nja (the rimoni x2)\nKeth atim ru ka cwinyi kwa, the rimoni ma ber.",
        "The rimoni, rimo ma ber, rimo mi lwok ma lwoko jo,\nGwoka Yesu Jalarna ndhu the rimoni ma ber.",
      ],
      [
        "Kwiocwiny ma ber ni ia (the rimoni x2)\nTic peri timbre ber iwa, the rimoni ma ber.",
        "The rimoni, rimo ma ber, rimo mi lwok ma lwoko jo,\nGwoka Yesu Jalarna ndhu the rimoni ma ber.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "Ju ma jusendogi pi yioyic gineno can, jutimogi rac.\nJumulogi ku goc ma lith, jumoko de juwang'u ku mac.",
        "Yioyic ma giciro ko, wan de wacir ko cil i tho.",
      ],
      [
        "Jucanyugi ku kidi de, palamularu negogi le.\nMange jutwiogi de ku kol, yioyic migi lokre de ngo.",
        "Yioyic ma giciro ko, wan de wacir ko cil i tho.",
      ],
      [
        "Kadok jumoko sendowa, wan wabed yo ku mer mandha.\nDong' wanyai lem mi kwo asu, ku bedopwe, ku lembe ma cu.",
        "Yioyic ma giciro ko, wan de wacir ko cil i tho.",
      ],
    ],
  },
  {
    ...
    body: [
      [
        "Wacidhu wu paker pa Rwoth m'Enyolowu ku yo mi both.\nWuai tho tho, wuci yau yau, wucwal tic man wurende pio.",
        "Wacidhu, wacidhu\nWothi yo mi kwo.\nWacidhu, wacidhu\nRwoth Yesu menyo yo.",
      ],
      [
        "Wacidhu ndhu kubang'wa yu ka palacam e eni ndhu.\nJukai mwoka wupoi pi koth, emaru nyotho cam pa Rwoth.",
        "Wacidhu, wacidhu\nWothi yo mi kwo.\nWacidhu, wacidhu\nRwoth Yesu menyo yo.",
      ],
      [
        "Wacidhu kud amora do kum jumalaika kengowa.\nUdul mi jumulembe de gitiekowa gikonyowa.",
        "Wacidhu, wacidhu\nWothi yo mi kwo.\nWacidhu, wacidhu\nRwoth Yesu menyo yo.",
      ],
      [
        "Wacidhu, ceng' udhingo mwony,\nKu mudho ticne timbre ngo.\nWuai ku rwo wukweru kpo, wulok cwiny ju m'urwinyo do.",
        "Wacidhu, wacidhu\nWothi yo mi kwo.\nWacidhu, wacidhu\nRwoth Yesu menyo yo.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "Wabi cokra i polo ku jumalaika pare.\nWabipake karacelo mal' i polo ba Mungu maleng.",
        "Wabinendra i polo, dhanu ceke ma giyio Yesu.\nWabibedo kud anyonga ni kum Rwoth mwa ma\nYesu Jalar.",
      ],
      [
        "Con ka Yesu dok i polo Eyiko kabedo iwa,\nEbijolowa i bang'e kara wabed ndhu kuca mi nja.",
        "Wabinendra i polo, dhanu ceke ma giyio Yesu.\nWabibedo kud anyonga ni kum Rwoth mwa ma\nYesu Jalar.",
      ],
      [
        "Wabibedo kud anyong'a ku juwadwa ma ni polo.\nWabifoye ka waneno udi dupa m'Eyiko ma cu.",
        "Wabinendra i polo, dhanu ceke ma giyio Yesu.\nWabibedo kud anyonga ni kum Rwoth mwa ma\nYesu Jalar.",
      ],
      [
        "Ceng' mange ma Yesu dwogo, ceng' maeca dhingo ceng'ni.\nDong' wabed ku rwo, wakie, bed ayika nicidho kude.",
        "Wabinendra i polo, dhanu ceke ma giyio Yesu.\nWabibedo kud anyonga ni kum Rwoth mwa ma\nYesu Jalar.",
      ],
    ],
  },
  ...
  },
  {
    ...
    titles: ["Anyong'a kwa! Rwoth Yesu wok!", "Joy to the World"],
    body: [
      [
        "Anyong'a kwa! Rwoth Yesu wok! Wajol Ubimo mwa!\nWek Emond i adundewa, Emi iwa mutoro kwa.",
        "(Wawer kud anyong'a x2)\nWawer, wawer kud anyong' a.",
      ],
      [
        "Anyong'a kwa Jalar mwa wok. Ekelo both iwa.\nWek Ekab kier ku dubo mwa Elonywa ni kum cilo mwa.",
        "(Wawer kud anyong'a x2)\nWawer, wawer kud anyong' a.",
      ],
      [
        "Anyong'a kwa, Rucwic uwok, Ekabu kwong' mi ng'om.\nEgonyo giracwia pet, ukudho, can, ku merone.",
        "(Wawer kud anyong'a x2)\nWawer, wawer kud anyong' a.",
      ],
      [
        "Anyong'a kwa, Jajuk uwok, m'Ejukowa mandha.\nEkwio cwiny, Ejuko can, Eyweyo piwang'wa m'uton.",
        "(Wawer kud anyong'a x2)\nWawer, wawer kud anyong' a.",
      ],
      [
        "Kero ku dwong' bed ire nja! Thek ceke pak nyinge!\nJudode Rwoth mi rwodhi kpo, mugisa kwa Emio nja.",
        "(Wawer kud anyong'a x2)\nWawer, wawer kud anyong' a.",
      ],
    ],
  },
  ...
  },
  {
    ...
    body: [
      [
        "Malaika tuco lembe pi nyathin ma Yesu Rwoth,\nMa junyolo i adhura pa Rwoth Daudi i Bethlehem",
        "Warum ire, kum Eromo, Wayunge Ubimo mwa.",
      ],
      [
        "Jukwac dupa igi wang' li ka gineno dwong' pa Rwoth.\nKa giwinjo rwonglembene gicidho kara giyunge.",
        "Warum ire, kum Eromo, Wayunge Ubimo mwa.",
      ],
      [
        "Ju ma riek gi ai yo nyangu gibino ni sayu Rwoth.\nCero telo yo i wang'gi cil m'ecungo ko wi nyathin.",
        "Warum ire, kum Eromo, Wayunge Ubimo mwa.",
      ],
      [
        "Ka jukelo nyathin Yesu ni thiere ba Rwoth Mungu.\nJu maleng' ma i hekalu gijole Jalar mi ng'om yu.",
        "Warum ire, kum Eromo, Wayunge Ubimo mwa.",
      ],
      [
        "Wa jupare ma wacokra ni rwo ire Jalar mwa.\nWaki bino pare kendo wabed ni jumandha i ng'om.",
        "Warum ire, kum Eromo, Wayunge Ubimo mwa.",
      ],
    ],
  },
